...
# Database
DB_URI = os.environ.get("DATABASE_URL", "postgres://gctpzosr:3eh1pMQ0UCJn67Vu70JVOXCq3ei-EuTI@flora.db.elephantsql.com/gctpzosr")

PROTECT_CONTENT = strtobool(os.environ.get("PROTECT_CONTENT", "False"))

# ID dari Channel Atau Group Untuk Wajib Subscribenya
FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001838265466"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1002097339342"))
